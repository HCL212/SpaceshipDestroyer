(* TODO: list of enemies, 4 rows, going side by side then down store in list
 * TODO: player ship lasers store in list
 * TODO: enemy lasers shooting back
     ...
     * type enemy =
     {
         ...
         time : float; 
         surf_rect: Tsdl.Sdl.rect;
     }

        type enemyList = enemy list

         // when we initialize
         let make_ship x y w h rect =
             x; y; w; h; surf_rect = rect
